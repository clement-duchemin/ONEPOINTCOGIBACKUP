...
document.addEventListener('DOMContentLoaded', function() {
    ...
    //display score
    const beforeScores = ["G3Q1NconfBefEn", "G3Q2NconfBefEn", "G3Q3ConfBefEn", "G3Q4ConfBefEn"];
    const afterScores = ["G3Q5NconfAftEn", "G3Q6NconfAftEn", "G3Q7ConfAftEn", "G3Q8ConfAftEn"];
    ...
    const ConjunctionFallacyGame = sessionStorage.getItem('ConjunctionFallacyGame');
...
function calculateScore(...values) {
  ...
  const scoreConfBef = calculateScore(
    sessionStorage.getItem('G3Q3ConfBefEn'),
    sessionStorage.getItem('G3Q4ConfBefEn')
  );
  
  const scoreNconfBef = calculateScore(
    sessionStorage.getItem('G3Q1NconfBefEn'), 
    sessionStorage.getItem('G3Q2NconfBefEn')
  );
  
  const scoreConfAft = calculateScore(
    sessionStorage.getItem('G3Q7ConfAftEn'),
    sessionStorage.getItem('G3Q8ConfAftEn')
  );
  
  const scoreNconfAft = calculateScore(
    sessionStorage.getItem('G3Q5NconfAftEn'),
    sessionStorage.getItem('G3Q6NconfAftEn')
  );
  

//Time spent on the task
const timeScores = ["TimeG3Q1NconfBefEn", "TimeG3Q2NconfBefEn", "TimeG3Q3ConfBefEn", "TimeG3Q4ConfBefEn", 
    "TimeG3Q5NconfAftEn", "TimeG3Q6NconfAftEn", "TimeG3Q7ConfAftEn", "TimeG3Q8ConfAftEn"];
...
//Task start time
const conjunctionFallacyStartTime = sessionStorage.getItem('conjunctionFallacyStartTime');

function sendData(uid, conjunctionFallacyStartTime, ConjunctionFallacyGame, scoreConfBef, scoreNconfBef, scoreConfAft, scoreNconfAft, time, age, gender, education, country, email, consent) {

    let data = {
        "cr40e_cogiuserid": uid,
        "cr40e_tempsdebuttache": conjunctionFallacyStartTime,
        "cr40e_cogitaskname": ConjunctionFallacyGame,
...
if (sessionStorage.getItem("age") !== null) {
  ...
  sendData(uid, conjunctionFallacyStartTime, ConjunctionFallacyGame, scoreConfBef, scoreNconfBef, scoreConfAft, scoreNconfAft, time, age, gender, education, country, email, consent);
