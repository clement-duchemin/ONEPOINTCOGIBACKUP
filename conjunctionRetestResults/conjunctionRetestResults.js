...
document.addEventListener('DOMContentLoaded', function() {
    ...
    //display score bat and ball 1st game
    ...
    const retestTotalScoreBef = ["G3Q9ConfBefEn"];
    const calculretestTotalScoreBef = calculateTotalScore(retestTotalScoreBef);
    const retestTotalScoreAft = ["G3Q10NconfAftEn", "G3Q11NconfAftEn", "G3Q12ConfAftEn", "G3Q13ConfAftEn"];
    ...
    const ConjunctionFallacyRetestGame = sessionStorage.getItem('ConjunctionFallacyRetestGame');
...
function calculateScore(...values) {
  ...
  const scoreConfBef = calculateScore(
    sessionStorage.getItem('G3Q9ConfBefEn'),
  );
  
  const scoreConfAft = calculateScore(
    sessionStorage.getItem('G3Q12ConfAftEn'),
    sessionStorage.getItem('G3Q13ConfAftEn')
  );
  
  const scoreNconfAft = calculateScore(
    sessionStorage.getItem('G3Q10NconfAftEn'),
    sessionStorage.getItem('G3Q11NconfAftEn')
  );
  

//Time spent on the task
const timeScores = ["TimeG3Q9ConfBefEn", "TimeG3Q12ConfAftEn", "TimeG3Q13ConfAftEn", "TimeG3Q10NconfAftEn", 
    "TimeG3Q11NconfAftEn"];
...
//Task start time
const conjunctionFallacyRetestStartTime = sessionStorage.getItem('conjunctionFallacyRetestStartTime');

function sendData(uid, conjunctionFallacyRetestStartTime, ConjunctionFallacyRetestGame, scoreConfBef, scoreConfAft, scoreNconfAft, time, age, gender, education, country, email, consent) {

    let data = {
        "cr40e_cogiuserid": uid,
        "cr40e_tempsdebuttache": conjunctionFallacyRetestStartTime,
        "cr40e_cogitaskname": ConjunctionFallacyRetestGame,
...
if (sessionStorage.getItem("age") !== null) {
  ...
  sendData(uid, conjunctionFallacyRetestStartTime, ConjunctionFallacyRetestGame, scoreConfBef, scoreConfAft, scoreNconfAft, time, age, gender, education, country, email, consent);
  ...
  // Event listener for the modal close icon
    ...
    document.getElementById('replay_button-en').addEventListener('click',  function() {
        ...
        window.location.href = "https://cogitum.powerappsportals.com/conjunctionRetestQuestions/";
    });
